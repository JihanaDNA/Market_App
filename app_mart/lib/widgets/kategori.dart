    ...
    child:  SingleChildScrollView(
      ...
      child: Padding(
        padding: EdgeInsets.symmetric(
          ...
          horizontal: screenWidth * 0.02, // Padding responsif untuk horizontal
        ),
        child: Row(
          children: [
            // Item pertama - All
            ...
            _buildCategoryItem(
              context,
              imagePath: "assets/burgerpaket.jpeg",
              label: "Paket Burger",
            ),
            ...
            _buildCategoryItem(
              context,
              imagePath: "assets/matchalatte.jpeg",
              label: "Matcha latte",
            ),
          ],
        ),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: Colors.white,
              borderRadius: BorderRadius.circular(screenWidth * 0.06), // Radius responsif
              boxShadow: [
                BoxShadow(
